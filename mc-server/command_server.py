...
@app.route('/api/cathy-today', methods=['POST'])
def post_cathy_today():
    ...
    post_date = body.get("post_date") or _date.today().isoformat()
    data = _load_cathy_posts()
    dates = data.get("dates", {})
